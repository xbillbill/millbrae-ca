...
const guideIndex = [
  ...
  { topic: 'FEATURE STORY', title: 'Schools remember a city, too', description: 'A long-form story about school communities, family routines, libraries, recreation, records, and shared local memory.', href: 'millbrae-story-school-community.html', keywords: 'schools school community memory family district MESD Mills library recreation records board history education' },
  ...
  { topic: 'PUBLIC RESOURCES', title: 'Millbrae public resources', description: 'Find emergency paths, permits, utilities, food and housing help, public benefits, voting, public works, library, transit, city contacts, and public help.', href: 'millbrae-public-resources.html', keywords: 'police fire emergency utility water garbage library public works permit permits planning remodeling housing food benefits CalFresh voting elections ballot county assistance' },
...
const queryAliases = {
  'zh-CN': { '公园': 'parks places trail', '学校': 'schools families school', '历史': 'history culture story', '交通': 'transit station train', '公共资源': 'public resources services', '公共服务': 'public resources services', '新闻': 'news community civic', '活动': 'events calendar civic', '商家': 'businesses directory restaurants story commerce corridor', '天气': 'weather current conditions', '来源': 'sources method evidence', '人口': 'population facts census', '社区': 'community neighborhoods', '参与': 'participation civic commission meeting', '图书馆': 'library learning makerspace', '学习': 'library learning school education', '词典': 'glossary terms places', '地点': 'places neighborhoods station parks', '住房': 'housing public resources assistance', '食物': 'food housing public resources assistance', '食品': 'food housing public resources assistance', '投票': 'voting elections ballot public resources', '选举': 'voting elections ballot public resources', '许可证': 'permit permits planning public resources', '装修': 'permit permits planning remodeling', '紧急': 'emergency fire police public resources' },
  es: { parque: 'parks places trail', parques: 'parks places trail', escuela: 'schools families school', escuelas: 'schools families school', historia: 'history culture story', transporte: 'transit station train', recursos: 'public resources services', noticias: 'news community civic', eventos: 'events calendar civic', negocios: 'businesses directory restaurants story commerce corridor', clima: 'weather current conditions', fuentes: 'sources method evidence', población: 'population facts census', comunidad: 'community neighborhoods', vivienda: 'housing public resources assistance', comida: 'food housing public resources assistance', alimentos: 'food housing public resources assistance', votar: 'voting elections ballot public resources', elecciones: 'voting elections ballot public resources', permisos: 'permit permits planning public resources', emergencia: 'emergency fire police public resources' }
};
...
const localizedResultCopy = {
  'zh-CN': {
    ...
    'Schools remember a city, too': { topic: '兴趣故事', title: '学校也记得一座城市', description: '了解学校社区、家庭日常、图书馆、休闲活动、记录和共同的地方记忆。' },
  ...
  es: {
    ...
    'Schools remember a city, too': { topic: 'HISTORIAS', title: 'Las escuelas también recuerdan una ciudad', description: 'Una historia sobre comunidades escolares, rutinas familiares, bibliotecas, recreación, registros y memoria local.' },
