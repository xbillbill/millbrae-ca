...
const translations = {
  'zh-CN': {
    ...
    'A correction needs a checkable trail.': '更正需要一条可核查的证据链。',
    ...
    'THE MILLBRAE REFERENCE INDEX': `${ZH_CITY_NAME}参考索引`,
    ...
    'Millbrae Place Glossary | Millbrae Local': `${ZH_CITY_NAME}地点词典 | Millbrae Local`,
    'The words that make Millbrae legible.': `让${ZH_CITY_NAME}变得清晰可读的词语。`,
    'Start with movement and geography.': '从交通与地理开始。',
    "Local Businesses Are Part of Millbrae's Map | Millbrae Local": `${ZH_CITY_NAME}本地商家也是城市地图的一部分 | Millbrae Local`,
    'Local businesses are part of Millbrae’s map.': `本地商家也是${ZH_CITY_NAME}地图的一部分。`,
    'Businesses live in corridors, not only categories.': '商家存在于商业走廊，而不只是类别中。',
    'A directory becomes useful when its labels stay intact.': '当目录保留清晰标签时，它才真正有用。',
    'One City, Overlapping Maps | Millbrae Local': '一座城市，多张重叠的地图 | Millbrae Local',
    'One city, overlapping maps.': '一座城市，多张重叠的地图。',
    '“Where is it?” depends on the decision.': '“它在哪里？”取决于你要做的决定。',
    'The Quiet Infrastructure Behind a Millbrae Day | Millbrae Local': '密尔布雷一天背后的安静基础设施 | Millbrae Local',
    'The quiet infrastructure behind a Millbrae day.': '密尔布雷一天背后的安静基础设施。',
    'A public question is usually an ownership question.': '一个公共问题通常也是一个责任归属问题。',
    'Schools Remember a City, Too | Millbrae Local': '学校也记得一座城市 | Millbrae Local',
    'Schools remember a city, too.': '学校也记得一座城市。',
    '“The schools” is a community map.': '“学校”也是一张社区地图。',
    'Places carry history as well as amenities.': '地点承载历史，也承载日常使用。',
    'Some local terms are doors, not destinations.': '有些本地术语是入口，而不是目的地。',
    ...
    'A few dates that change the picture.': '几个改变城市图景的日期。',
    'When the question is bigger than one department.': '当问题不只属于一个部门时。',
    'Find the right source in one search.': '用一次搜索找到正确来源。',
    'Search the Millbrae knowledge hub': '搜索密尔布雷知识中心',
  ...
  es: {
    ...
    'A correction needs a checkable trail.': 'Una corrección necesita un rastro verificable.',
    ...
    'THE MILLBRAE REFERENCE INDEX': 'ÍNDICE DE REFERENCIA DE MILLBRAE',
    'Browse by topic': 'Explora por tema',
    ...
    'Millbrae Place Glossary | Millbrae Local': 'Glosario de lugares de Millbrae | Millbrae Local',
    'The words that make Millbrae legible.': 'Las palabras que hacen comprensible Millbrae.',
    'Start with movement and geography.': 'Empieza con movimiento y geografía.',
    "Local Businesses Are Part of Millbrae's Map | Millbrae Local": 'Los negocios locales son parte del mapa de Millbrae | Millbrae Local',
    'Local businesses are part of Millbrae’s map.': 'Los negocios locales son parte del mapa de Millbrae.',
    'Businesses live in corridors, not only categories.': 'Los negocios viven en corredores, no solo en categorías.',
    'A directory becomes useful when its labels stay intact.': 'Un directorio es útil cuando conserva sus etiquetas.',
    'One City, Overlapping Maps | Millbrae Local': 'Una ciudad, mapas superpuestos | Millbrae Local',
    'One city, overlapping maps.': 'Una ciudad, mapas superpuestos.',
    '“Where is it?” depends on the decision.': '“¿Dónde está?” depende de la decisión.',
    'The Quiet Infrastructure Behind a Millbrae Day | Millbrae Local': 'La infraestructura silenciosa detrás de un día en Millbrae | Millbrae Local',
    'The quiet infrastructure behind a Millbrae day.': 'La infraestructura silenciosa detrás de un día en Millbrae.',
    'A public question is usually an ownership question.': 'Una pregunta pública suele ser una pregunta sobre quién es responsable.',
    'Schools Remember a City, Too | Millbrae Local': 'Las escuelas también recuerdan una ciudad | Millbrae Local',
    'Schools remember a city, too.': 'Las escuelas también recuerdan una ciudad.',
    '“The schools” is a community map.': '“Las escuelas” son un mapa comunitario.',
    'Places carry history as well as amenities.': 'Los lugares guardan historia y también servicios cotidianos.',
    'Some local terms are doors, not destinations.': 'Algunos términos locales son puertas, no destinos.',
    ...
    'A few dates that change the picture.': 'Algunas fechas que cambian la imagen.',
    'When the question is bigger than one department.': 'Cuando la pregunta abarca más de un departamento.',
    'Find the right source in one search.': 'Encuentra la fuente correcta con una sola búsqueda.',
    'Search the Millbrae knowledge hub': 'Busca en el centro de conocimiento de Millbrae',
